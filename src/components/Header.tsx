      ...
      <div className="w-full px-3 lg:px-5 h-13 flex items-center justify-between gap-3 text-xs">
        ...
        <div className="flex-1 max-w-sm mx-2">
          <button
            ...
            className="w-full flex items-center justify-between px-2.5 py-1.5 rounded bg-slate-50 dark:bg-black/50 border border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:border-orange-500/50 hover:text-slate-900 dark:hover:text-slate-200 transition text-xs"
          >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {onOpenDividend && (
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1 px-2 py-1 rounded hover:bg-slate-100 dark:hover:bg-white/5 text-slate-600 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white text-xs transition"
            >
