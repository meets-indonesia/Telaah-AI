  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-[#f6f8fb] dark:bg-[#090d16] text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <main id="main-content" className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        <FeaturePageHeader icon={Radar} title="Pantau langkah orang dalam" description="Lihat transaksi direksi, komisaris, dan pemegang saham besar. Kami menandai pola pembelian berkelompok agar sinyal penting lebih cepat terbaca." activeSymbol={symbol} symbols={sampleEmiten} onSelectSymbol={loadEmitenData} />
